...
#include <QMessageBox>
#include <iostream>
#include "../include/thormang3_ndaj_demo/main_window.hpp"
...
// Added
void MainWindow::on_button_wheel_pose_clicked(bool check)
{
  qnode_thor3_.moveWheelPose();
}
// Added
void MainWindow::on_button_wheel_to_init_pose_clicked(bool check)
{
  qnode_thor3_.moveWheelToInitPose();
}
