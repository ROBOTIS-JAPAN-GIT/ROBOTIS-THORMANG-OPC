...
#include "../include/thormang3_ndaj_demo/qnode.hpp"
...
bool QNodeThor3::init()
{
  ...
  wheel_pose_pub_ = nh.advertise<std_msgs::String>("/robotis/wheel/wheel_pose", 0); // added
  wheel_to_init_pose_pub_ = nh.advertise<std_msgs::String>("/robotis/wheel/wheel_pose", 0); // added
...
// added
void QNodeThor3::moveWheelPose()
{
  std_msgs::String wheel_msg;
  wheel_msg.data = "wheel_pose";

  wheel_pose_pub_.publish(wheel_msg);

  log(Info, "Go to robot wheel pose.");
}

// added
void QNodeThor3::moveWheelToInitPose()
{
  std_msgs::String wheel_to_init_msg;
  wheel_to_init_msg.data = "wheel_to_init_pose";

  wheel_to_init_pose_pub_.publish(wheel_to_init_msg);
